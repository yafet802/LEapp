...
class _ApartadoActividadState extends State<ApartadoActividad> with SingleTickerProviderStateMixin{
                                              ...
                                              child: Stack(
                                                ...
                                                children: [
                                                  Positioned(left: 26.0.w,
                                                    child: Text('Lecciones', style: TextStyle(color: const Color.fromRGBO(126, 132, 148, 1), fontFamily: 'Poppins-SemiBold', fontSize: 20.0.sp))
                                                  ),
                                                  Positioned(right: 29.0.w,
                                                    child: Text('00/00', style: TextStyle(color: widget.colorLetra, fontFamily: 'Poppins-SemiBold', fontSize: 20.0.sp))
                                                  ),
                                                ],
                                              ),
                                            ),
                  ...
                  child: Wrap(
                    ...
                    children: [
                      Container(
                        ...
                        child: Center(child: Text(widget.letra, style: TextStyle(color: Colors.white, fontFamily: 'Poppins-SemiBold', fontSize: 48.0.sp))),
                      ),
